...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xlink="http://www.w3.org/1999/xlink"
  ...
  <xsl:variable name="PageTitle" select="'browsingPage'" />
  <xsl:variable name="breadCrumb">
      <xsl:apply-templates select="document(concat('mcrobject:', /response/result/doc[1]/str[@name='id']))" mode="breadCrumb" />
  </xsl:variable>
  ...
  <xsl:template match="/response">
    ...
    <div class="floatbox" id="browse">
      ...
      <div class="text-right" id="search_back">
        <a href="{$href}">
